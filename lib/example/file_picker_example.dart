...
//void main() => runApp(const MyAppDocPicker());

class MyAppDocPicker extends StatefulWidget{
  const MyAppDocPicker({Key? key}) : super(key: key);
  @override
  _MyAppDocPickerState createState() => _MyAppDocPickerState();
}

class _MyAppDocPickerState extends State<MyAppDocPicker> {
  String _path = '-';
