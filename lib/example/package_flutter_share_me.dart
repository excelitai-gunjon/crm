...
class MyAppFlutterShareMe extends StatefulWidget {
  @override
  _MyAppFlutterShareMeState createState() => _MyAppFlutterShareMeState();
}
class _MyAppFlutterShareMeState extends State<MyAppFlutterShareMe>{
  File? file;
