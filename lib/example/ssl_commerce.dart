...
class MyAppSSlCommerce extends StatefulWidget {
  @override
  _MyAppSSlCommerceState createState() => _MyAppSSlCommerceState();
}

class _MyAppSSlCommerceState extends State<MyAppSSlCommerce> {
