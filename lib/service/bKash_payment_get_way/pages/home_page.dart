...
class BkashHomePage extends StatefulWidget {
  //final String? title;
  BkashHomePage({Key? key}) : super(key: key);
  @override
  _BkashHomePageState createState() => _BkashHomePageState();
}

class _BkashHomePageState extends State<BkashHomePage> {
